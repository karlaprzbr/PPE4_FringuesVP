    ...
    <body>
        ...
        <div id="sideNav">
            <div id="contenu">
                ...
                <a href="homme_bas.php" class="active">Jeans, pantalons, shorts</a>
