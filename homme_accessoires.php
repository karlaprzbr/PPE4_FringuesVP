    ...
    <body>
        ...
        <div id="sideNav">
            <div id="contenu">
                ...
                <a href="homme_accessoires.php" class="active">Chaussures, accessoires</a>
            </div>
        </div>
