    ...
    <body>
        ...
        <div id="sideNav">
            <div id="contenu">
                ...
                <a href="femme_accessoires.php" class="active">Chaussures, accessoires</a>
            </div>
        </div>
